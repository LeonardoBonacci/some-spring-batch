 ...
 */
@Component
public class EndBalanceValidatingItemProcessor extends ValidatingItemProcessor<Transaction> {

	
	public EndBalanceValidatingItemProcessor(EndBalanceValidator validator) {
		super(validator);
	}
}
